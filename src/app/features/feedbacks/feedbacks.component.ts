...
import { catchError, finalize, map, of, startWith, tap } from "rxjs";
...
@Component({
  ...
  standalone: true,
  imports: [MatCardModule, TranslateModule, AsyncPipe, NgOptimizedImage, StarRatingComponent, ProcessWheelComponent],
